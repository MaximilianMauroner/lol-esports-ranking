  ...
  return (
    <span className="relative inline-flex min-w-0">
      <select
        data-slot="select"
        className={cn(
          'h-[var(--control-h)] min-w-[120px] max-w-[260px] appearance-none rounded-[var(--r-2)] border border-[var(--line-strong)] bg-[var(--surface-2)] px-3 py-1 pr-8 text-sm text-[var(--text)] outline-none transition-colors hover:border-[var(--accent-line)] focus-visible:border-[var(--accent-line)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus)] disabled:cursor-not-allowed disabled:opacity-45',
          className,
        )}
        {...props}
      >
