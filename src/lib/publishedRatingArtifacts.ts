...
function toPublishedRatingUpdate(
  ...
  return {
    ...
    ...(update.baseTeamStableDelta !== undefined ? { baseTeamStableDelta: publishedDeltaOneDecimal(update.baseTeamStableDelta, scale) } : {}),
    ...(update.baseTeamFormDelta !== undefined ? { baseTeamFormDelta: publishedDeltaOneDecimal(update.baseTeamFormDelta, scale) } : {}),
    ...(update.baseLeagueDelta !== undefined ? { baseLeagueDelta: publishedDeltaOneDecimal(update.baseLeagueDelta, scale) } : {}),
